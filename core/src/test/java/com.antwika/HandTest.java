...
public class HandTest {
    ...
    public void toLongNotation() {
        assertEquals("High card, ", Hand.toLongNotation(Hand.toHand("2c4d6h8sTcQdAh")));
        assertEquals("One pair, ", Hand.toLongNotation(Hand.toHand("2c2d6h8sTcQdAh")));
        assertEquals("Two pair, ", Hand.toLongNotation(Hand.toHand("2c2d6h6sTcQdAh")));
        assertEquals("Trips, ", Hand.toLongNotation(Hand.toHand("2c2d2h6sTcQdAh")));
        assertEquals("Straight, ", Hand.toLongNotation(Hand.toHand("2c3d4h5s6cQdAh")));
        assertEquals("Flush, ", Hand.toLongNotation(Hand.toHand("2c4c6c8cTcQdAd")));
        assertEquals("Full house, ", Hand.toLongNotation(Hand.toHand("2c2d2h6s6cQdAh")));
        assertEquals("Quads, ", Hand.toLongNotation(Hand.toHand("2c2d2h2s6cQdAh")));
        assertEquals("Straight flush, ", Hand.toLongNotation(Hand.toHand("2c3c4c5c6cQdAd")));
    }

    @Test
    public void rankToLogNotation() {
        assertEquals("Two", Hand.rankToLogNotation(Hand.toHand("2c"), false));
        assertEquals("Three", Hand.rankToLogNotation(Hand.toHand("3c"), false));
        assertEquals("Four", Hand.rankToLogNotation(Hand.toHand("4c"), false));
        assertEquals("Five", Hand.rankToLogNotation(Hand.toHand("5c"), false));
        assertEquals("Six", Hand.rankToLogNotation(Hand.toHand("6c"), false));
        assertEquals("Seven", Hand.rankToLogNotation(Hand.toHand("7c"), false));
        assertEquals("Eight", Hand.rankToLogNotation(Hand.toHand("8c"), false));
        assertEquals("Nine", Hand.rankToLogNotation(Hand.toHand("9c"), false));
        assertEquals("Ten", Hand.rankToLogNotation(Hand.toHand("Tc"), false));
        assertEquals("Jack", Hand.rankToLogNotation(Hand.toHand("Jc"), false));
        assertEquals("Queen", Hand.rankToLogNotation(Hand.toHand("Qc"), false));
        assertEquals("King", Hand.rankToLogNotation(Hand.toHand("Kc"), false));
        assertEquals("Ace", Hand.rankToLogNotation(Hand.toHand("Ac"), false));

        assertEquals("Twos", Hand.rankToLogNotation(Hand.toHand("2c2d"), false));
        assertEquals("Threes", Hand.rankToLogNotation(Hand.toHand("3c3d"), false));
        assertEquals("Fours", Hand.rankToLogNotation(Hand.toHand("4c4d"), false));
        assertEquals("Fives", Hand.rankToLogNotation(Hand.toHand("5c5d"), false));
        assertEquals("Sixes", Hand.rankToLogNotation(Hand.toHand("6c6d"), false));
        assertEquals("Sevens", Hand.rankToLogNotation(Hand.toHand("7c7d"), false));
        assertEquals("Eights", Hand.rankToLogNotation(Hand.toHand("8c8d"), false));
        assertEquals("Nines", Hand.rankToLogNotation(Hand.toHand("9c9d"), false));
        assertEquals("Tens", Hand.rankToLogNotation(Hand.toHand("TcTd"), false));
        assertEquals("Jacks", Hand.rankToLogNotation(Hand.toHand("JcJd"), false));
        assertEquals("Queens", Hand.rankToLogNotation(Hand.toHand("QcQd"), false));
        assertEquals("Kings", Hand.rankToLogNotation(Hand.toHand("KcKd"), false));
        assertEquals("Aces", Hand.rankToLogNotation(Hand.toHand("AcAd"), false));

        assertEquals("Two", Hand.rankToLogNotation(Hand.toHand("2c2d"), true));
        assertEquals("Three", Hand.rankToLogNotation(Hand.toHand("3c3d"), true));
        assertEquals("Four", Hand.rankToLogNotation(Hand.toHand("4c4d"), true));
        assertEquals("Five", Hand.rankToLogNotation(Hand.toHand("5c5d"), true));
        assertEquals("Six", Hand.rankToLogNotation(Hand.toHand("6c6d"), true));
        assertEquals("Seven", Hand.rankToLogNotation(Hand.toHand("7c7d"), true));
        assertEquals("Eight", Hand.rankToLogNotation(Hand.toHand("8c8d"), true));
        assertEquals("Nine", Hand.rankToLogNotation(Hand.toHand("9c9d"), true));
        assertEquals("Ten", Hand.rankToLogNotation(Hand.toHand("TcTd"), true));
        assertEquals("Jack", Hand.rankToLogNotation(Hand.toHand("JcJd"), true));
        assertEquals("Queen", Hand.rankToLogNotation(Hand.toHand("QcQd"), true));
        assertEquals("King", Hand.rankToLogNotation(Hand.toHand("KcKd"), true));
        assertEquals("Ace", Hand.rankToLogNotation(Hand.toHand("AcAd"), true));
    }
}
